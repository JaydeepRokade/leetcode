...
public:
    int countDays(int days, vector<vector<int>>& meetings) {
        ...
        //sxkskk jsnnslkk ks/kdlklldca.dv ndkjnnsvkj kjcsj,ncn//lnvljnclj nljcnwlnc lndljn'l ndvls'llj ljcsslcc jncvljnflj ldjvnen jdvljdn ldvl 'ln 'dnv'dl lnc lfjbljdal l n'lvvldldl vdv''dv
